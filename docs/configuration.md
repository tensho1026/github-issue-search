...
The three implemented caches are in-memory, capacity-bounded TTL/LRU adapters:

| Cache            | Default TTL | Default capacity | Canonical key                                          |
| ---------------- | ----------: | ---------------: | ------------------------------------------------------ |
| Profile analysis |  30 minutes |              500 | Validated lowercase username                           |
| Issue search     |   5 minutes |             1000 | Normalized discovery filters; excludes page and effort |
