...
| `pnpm run contracts:embed`                        | Refresh the API binary's embedded OpenAPI copy       |
| `pnpm run contracts:embed:check`                  | Reject a stale embedded OpenAPI copy                 |
| `pnpm run contracts:examples`                     | Refresh validated fixture examples in OpenAPI        |
| `pnpm run contracts:examples:check`               | Reject stale generated fixture examples              |
...
| `pnpm run contracts:sync`                         | Refresh examples and embedded OpenAPI in order       |
