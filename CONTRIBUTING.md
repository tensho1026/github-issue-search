...
The stable branch-protection status is `CI / required`. Individual path-aware jobs may be skipped, but the aggregate status fails if any applicable job fails or is cancelled.
